...
public class ArrayVersusArrayList {
    ...
    public static void lastComesFirst(ArrayList<String> arrList) {
        ...
        String last = arrList.remove(arrList.size() - 1); // remove last
        arrList.add(0, last); // insert at front
    }

    // modifies the given array by moving the first element to the last index, and
    // shifting all
    // other elements to the left.
    // Works on an array. Arrays have a fixed size. Move items by shifting with a
    // loop.
    ...
    // shifting all
    // other elements to the left.
    // Works on an ArrayList, which can change size and have methods like remove and
    // add
    public static void firstComesLast(ArrayList<String> arrList) {
        ...
        String first = arrList.remove(0); // remove first
        arrList.add(first); // add to end
    }

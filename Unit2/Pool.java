public class Pool {
    ...
    public String toString() {
        return "== ABOUT POOL ==\n" + "Name: " + name + "\nOwner: " 
            ...
            + PoolUtils.generateUsername(username) + "\nCleanliness Level: " 
    ...
    public boolean equals(Pool other) {
        if (this.name.equals(other.name) && this.fixName().equals(other.fixName()) 
            && this.generateUsername().equals(other.generateUsername()) 
